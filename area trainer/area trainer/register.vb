Public Class register
    ...
    Private Sub register_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.Turquoise ' sets the backcolor to a nice color
    ...
    Function nameCheck(ByRef name As String) ' checks if the name is valid
        ...
        ' if these two are satisfied, it returns that the username is fine
        Return True
    End Function
    ...
    Private Sub sign_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sign.Click
        If nameCheck(uname.Text) Then ' if the name is valid after being checksed
            If passChecker(pass1.Text) = "" Then ' if the password is strong enough after being checked (will be blank if there are no errors)
                createUSer() ' creates the file with all the necassary data
                Main_page.Show() ' allows them to now login, and closes the registration window
                Me.Close()
            End If
        End If
    ...
    Private Sub pass1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pass1.TextChanged ' evaluates the password as they enter it
    ...
    Private Sub pass2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pass2.TextChanged ' evaluates the password as they enter
        issues.Text = passChecker(pass1.Text)
    End Sub
End Class